...
Во-первых, на реальных рынках торги ведутся, как правило, не единичными активами, а пакетами активов: например, на рынке Forex размер пакета равен 1000 единиц валюты --- так называемый микролот. Таким образом, можно положить, что торги ведутся в долларах, а расчет осуществляется в центах.
