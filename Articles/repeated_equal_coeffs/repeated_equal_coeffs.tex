...
\begin{note}
Вспомним, что платежные матрицы $A^H$ и $A^L$ для удобства были умножены на $2$, и игра $G^m_\infty(p)$ рассматривалась именно с этими модифицированными матрицами. Если вернуться к оригинальным матрицам, то значение игры будет равно
\[
