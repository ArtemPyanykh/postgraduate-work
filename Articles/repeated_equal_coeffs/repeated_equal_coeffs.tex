...
Во-первых, на реальных рынках торги ведутся, как правило, не единичными активами, а пакетами активов достаточно большого размера. И если рассматривать задачу в такой постановке, то можно положить, что ставки игроков пропорциональны долларам, а финальный расчет осуществляется в центах.
