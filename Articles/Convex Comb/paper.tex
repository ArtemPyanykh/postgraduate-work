...
После этого на протяжении $ n \leq \infty $ шагов игроки играют в игру $ A^{s,\beta} $.
...
\begin{proposition}
  ...
  \begin{gather*}
    L_{2k+1} = ((m - (k + \beta))(k + \beta) + \alpha\beta)/2, \, k = \overline{0, m-1}, \\
