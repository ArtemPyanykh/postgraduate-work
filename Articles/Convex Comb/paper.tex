...
Очевидно, что выражения $h_n^L(\tau^k)$ и $h_n^H(\tau^k)$ монотонны и ограничены сверху по $n$.
...
\[
L_{2k} = \lowerBound{k/m}, \, k = \overline{0,m}, \:%
...
\begin{equation}
  ...
  \begin{gathered}
    L_{2k+1} = \alpha\beta + \alpha L_{2k} + \beta L_{2(k+1)}, \, k = \overline{0, m-1},\\
    L_{2k} = \beta L_{2k-1} + \alpha L_{2k+1}, \, k = \overline{1, m-1},\\
    L_0 = L_{2m} = 0.
  \end{gathered}
\end{equation}
...
\begin{proposition}
  ...
  Решение системы {\normalfont(\ref{eq:lowerRecurrence})} дается следующими формулами:
  \begin{gather*}
...
\begin{theorem}
  ...
  При этом $\fOpt$ -- оптимальная стратегия первого игрока, а $\tau^*$ -- оптимальная стратегия второго игрока.
\end{theorem}
...
\begin{thebibliography}{99}\itemsep=-2pt
  ...
  \bibitem{demeyer02}
    De Meyer B., Saley H.\,: On the strategic origin of Brownian motion in finance~// International Journal of Game Theory. 2002. {\bfseries 31}. N~2. P.\, 285--319.
  ...
  \selectlanguage{english}
  \bibitem{domansky07}%
    Domansky V.\,: Repeated games with asymmetric information and random price fluctuations at finance markets~// International Journal of Game Theory. 2007. {\bfseries 36}. N~2. P.\, 265--281.
